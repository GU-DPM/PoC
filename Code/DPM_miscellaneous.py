...
def DPM_miscellaneous_treatment_change_time(d: np.ndarray):
    ...
    # Position where the drug dose changes.#
    pos_changedose += 1
    # At the beginning (index=0), drug dose always changes. This represents the start of treatment, as all previous doses are zero.#
